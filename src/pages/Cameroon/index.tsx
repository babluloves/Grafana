  ...
  React.useEffect(() => {
   ...
   const performRequest = async (fromUnixTime: number, toUnixTime: number) => {
    const postData ={
        "queries": [
          {
            ...
            "editorMode": "code",
            "expr": "sum(com_comviva_kpi_Custom_PartnerApiErrorCnt_cnt{key_=~\"(ACTIVATION|BUNDLE|DEACTIVATION|EVENT|NONE|OPT_IN)\",app=~\"request-mediator-service\",key!~\"-1\"}-com_comviva_kpi_Custom_PartnerApiErrorCnt_cnt{key_=~\"(ACTIVATION|BUNDLE|DEACTIVATION|EVENT|NONE|OPT_IN)\",app=~\"request-mediator-service\",key!~\"-1\"} offset $__interval) by(key) >=0 or sum(com_comviva_kpi_Custom_PartnerApiErrorCnt_cnt{key_=~\"(ACTIVATION|BUNDLE|DEACTIVATION|EVENT|NONE|OPT_IN)\",app=~\"request-mediator-service\"}) by(key)",
            "format": "table",
            "legendFormat": "Total",
            "range": true,
            "refId": "A",
          ...
          },
          {
            ...
            "editorMode": "code",
            "expr": "sum(com_comviva_kpi_Custom_PartnerApiErrorCnt_cnt{key_=~\"(ACTIVATION|BUNDLE|DEACTIVATION|EVENT|NONE|OPT_IN)\",code=~\"3021|3028|3027|0|6000|6002\",app=~\"request-mediator-service\",key!~\"-1\"}-com_comviva_kpi_Custom_PartnerApiErrorCnt_cnt{key_=~\"(ACTIVATION|BUNDLE|DEACTIVATION|EVENT|NONE|OPT_IN)\",code=~\"3021|3028|3027|0|6000|6002\",app=~\"request-mediator-service\",key!~\"-1\"} offset $__interval) by(key) >=0 or sum(com_comviva_kpi_Custom_PartnerApiErrorCnt_cnt{key_=~\"(ACTIVATION|BUNDLE|DEACTIVATION|EVENT|NONE|OPT_IN)\",code=~\"3021|3028|3027|0|6000|6002\",app=~\"request-mediator-service\",key!~\"-1\"}) by(key)",
            "format": "table",
            "hide": false,
        ...
        range: {
          from: "2024-01-10T15:00:42.249Z",
          to: "2024-01-10T15:05:42.249Z",
          raw: {
            from: "now-5m",
            to: "now"
          }
